...
this.Concatenator = class Concatenator {
  constructor(webapp) {
    ...
    this.webapp.app.get(/^\/audioengine.js$/, (req, res) => {
      res.setHeader("Content-Type", "text/javascript");
      if (!this.webapp.server.use_cache) {
        return this.concat(this.audioengine_js, "audioengine_js_concat", () => {
          return res.send(this.audioengine_js_concat);
        });
      } else {
        return res.send(this.audioengine_js_concat);
      }
    ...
    this.server_js = ["/js/languages/microscript/random.js", "/js/runtime/microvm.js", '/js/runtime/watcher.js', '/js/runtime/assetmanager.js', '/js/runtime/runtime_server.js', '/js/runtime/watcher.js', '/js/runtime/map.js', '/js/terminal/terminal.js', '/js/debug/watch.js', '/js/play/server.js', '/js/play/serverclient.js'];
