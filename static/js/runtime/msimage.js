...
this.msImage = (function() {
  ...
  msImage.prototype.drawPolyline = function() {
  ...
  msImage.prototype.drawPolygon = function() {
    var args, i, j, len, ref, transform;
    args = arguments;
    this.initContext();
    if (args.length > 0 && args.length % 2 === 1 && typeof args[args.length - 1] === "string") {
  ...
  msImage.prototype.fillPolygon = function() {
    var args, i, j, len, ref, transform;
    args = arguments;
    this.initContext();
    if (args.length > 0 && args.length % 2 === 1 && typeof args[args.length - 1] === "string") {
  ...
  msImage.prototype.drawQuadCurve = function() {
  ...
  msImage.prototype.drawBezierCurve = function() {
    var args, index, len, transform;
    args = arguments;
    this.initContext();
    if (args.length > 0 && args.length % 2 === 1 && typeof args[args.length - 1] === "string") {
  ...
  msImage.prototype.drawArc = function(x, y, radius, angle1, angle2, ccw, color) {
    this.initContext();
    this.setColor(color);
    this.context.globalAlpha = this.alpha;
    this.context.lineWidth = this.line_width;
  ...
  msImage.prototype.fillArc = function(x, y, radius, angle1, angle2, ccw, color) {
    this.initContext();
    this.setColor(color);
    this.context.globalAlpha = this.alpha;
    this.context.lineWidth = this.line_width;
