...
this.DrawTool = (function() {
  ...
  DrawTool.prototype.getRoundness = function() {
    if (this.shape === "round") {
      return 1;
    } else {
      return 0;
  ...
  DrawTool.prototype.start = function(sprite, x, y, button, shiftkey) {
    this.pixels = {};
    if (!shiftkey) {
      this.last_x = x;
      this.last_y = y;
  ...
  DrawTool.prototype.domove = function(sprite, x, y, button, pass) {
