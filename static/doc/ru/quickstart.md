...
* **Справка**: здесь вы можете написать документацию для своего проекта; это может быть документ по дизайну игры, учебник, руководство по повторному использованию вашего проекта в качестве шаблона и т.д.
