  ...
  function WebApp(server, app) {
    ...
    this.app.get(/^\/[^\/\|\?\&\.]+\/[^\/\|\?\&\.]+(\/([^\/\|\?\&\.]+\/?)?)?$/, (function(_this) {
      return function(req, res) {
        ...
        if (_this.server.config.player_extra_js != null) {
          jsfiles = jsfiles.concat(_this.server.config.player_extra_js);
        }
              ...
              return manager.listFiles("sounds", function(sounds) {
                return manager.listFiles("music", function(music) {
                  return manager.listFiles("assets", function(assets) {
                    ...
                    if ((req.query != null) && (req.query.srv != null)) {
                      if ((_this.server_funk == null) || !_this.server.use_cache) {
                        _this.server_funk = pug.compileFile("../templates/play/server.pug");
                      }
                      pf = _this.server_funk;
                    } else {
    ...
    this.app.get(/^\/[^\/\|\?\&\.]+\/[^\/\|\?\&\.]+(\/([^\/\|\?\&\.]+)?)?\/assets\/[A-Za-z0-9_-]+.(glb|obj|jpg|png|ttf|txt|csv|json|md)$/, (function(_this) {
      return function(req, res) {
