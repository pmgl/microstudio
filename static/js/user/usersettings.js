this.UserSettings = (function() {
  function UserSettings(app) {
    ...
    if (window.ms_standalone) {
      ...
      document.getElementById("show-account-deletion").addEventListener("click", (function(_this) {
        return function() {
          var e;
      ...
      document.getElementById("delete-account-button").addEventListener("click", (function(_this) {
        return function() {
          return _this.deleteAccount();
        };
      })(this));
      checkDeleteButton = (function(_this) {
        return function() {
  ...
  UserSettings.prototype.deleteAccount = function() {
    var password, text;
    ...
    if (text === "DELETE MY ACCOUNT") {
      ...
      return this.app.client.sendRequest({
        ...
        return function(msg) {
          console.info(msg);
          if (msg.name === "error") {
            return document.getElementById("delete-account-error").innerText = _this.app.translator.get(msg.error);
          } else {
            document.getElementById("delete-account-error").innerText = _this.app.translator.get("Account Deleted Successfully. You will be redirected.");
