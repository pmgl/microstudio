...
AppUI = (function() {
      ...
      return function(e) {
        if ((window.navigator.platform.match("Mac") ? e.metaKey : e.ctrlKey) && e.keyCode === 83) {
          ...
          switch (_this.current_section) {
            ...
            case "assets":
              return _this.app.assets_manager.text_viewer.checkSave(true);
          }
        }
      };
    })(this));
  ...
  AppUI.prototype.updateProjectTitle = function() {
    var html;
    if (this.project != null) {
  ...
  AppUI.prototype.createFullscreenFeatures = function() {
    var button;
    ...
    return window.addEventListener("fullscreenchange", (function(_this) {
      return function() {
        if (document.fullscreenElement) {
  ...
  AppUI.prototype.createMainMenuFunction = function() {
  ...
  AppUI.prototype.createProjectSideBarCollapse = function() {
    var collapse_time, resize_until;
    collapse_time = 0;
    resize_until = Date.now();
    this.makeProjectSideBarVisible = (function(_this) {
      return function() {
    ...
    window.addEventListener("resize", (function(_this) {
      return function() {
        if (!document.getElementById("projectview").classList.contains("sidebar-collapsed") && window.innerWidth < 600) {
          ...
          return _this.makeProjectSideBarVisible();
        }
      };
    })(this));
    return setInterval(((function(_this) {
